...
while elapsed_seconds <= sim_duration_seconds:
    ...
    all_cleanup_idx = cleanup_timeout_targets(
        all_targets,
        tasked_targets,
        t_datetime,
        observation_time_limit,
        cleanup_idx,
        eo_tools_dict,
        att_models_dict,
        eul_ang_cue_default
    ...
    for actor in cue_actors:
        ...
        if cue_illuminated:
            ...
            if eo_tools_dict[actor.name].current_task is None:
                ...
                actor_not_default = not np.allclose(actor_eul, eul_ang_cue_default, atol=0.1)
                new_target_not_default = not np.allclose(new_target_eul, eul_ang_cue_default, atol=0.1)
