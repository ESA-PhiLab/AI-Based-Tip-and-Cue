...
def get_resourcesat_satellites() -> list[SatelliteInfo]:
    """Return Resourcesat-2 and Resourcesat-2A with valid time ranges."""
    return [
        SatelliteInfo(
            name="Resourcesat-2",
            norad_id=37387,
            earliest_valid_utc=datetime(2011, 4, 20, 0, 0, 0, tzinfo=timezone.utc),
        ),
        SatelliteInfo(
            name="Resourcesat-2A",
            norad_id=41877,
            earliest_valid_utc=datetime(2016, 12, 7, 0, 0, 0, tzinfo=timezone.utc),
        ),
    ]
...
if __name__ == "__main__":
    ...
    satellites = get_resourcesat_satellites()
