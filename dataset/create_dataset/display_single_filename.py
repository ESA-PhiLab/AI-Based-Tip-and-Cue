...
ID_INPUT = 1000       # ID of input image (for reference, if you want to keep it)
IMAGE_FILENAME = "Valdes2012/Valdes_SRW_WV2_PS_20120919_B0_000049_F_10deg.PNG"  # Example input filename (can be replaced dynamically)
...
def show_data() -> None:
    ...
    if not image:
        print(f"Image with filename {IMAGE_FILENAME} not found in dataset.")
        return
